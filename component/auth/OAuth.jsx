      ...
      <ScrollView contentContainerStyle={{ flexGrow:1 }}>
       <View className={`flex-1 justify-center items-center`}>
        ...
        <View className={`relative`}>
          ...
          <Image className={`absolute ${Platform.OS === 'ios'? 'ml-[64%]':'hidden'} mt-[54px] h-[20%] w-[19%]`} resizeMode='contain' source={images.path} />
        </View>
        <Text className={`text-gray-100 text-sm mt-4 text-center font-pregular mb-7`}>Where creativity meets innovation: embark on a journey of limitless exploration with Aora</Text>
